...
app = discord.Client()
token = "NjI5MjQ0MTg4MjMxNDY3MDA5.XZmboQ.1fRWAZrs9s8RvDEvzCv8taR6_vg"
...
async def on_message(message):
    ...
    if message.content == "@샆할사람":
        await message.channel.send("<@581118510412070913> <@252091791682043904> <@263668000270319618> <@343076346165198848> <@258520817967562752> <@389408270483193858> <@242586194733432832> <@390462378942398465>")
        
    if message.content == "@뎁데할사람":
        await message.channel.send("<@343076346165198848> <@581118510412070913> <@252091791682043904> <@571002715702820915> <@263668000270319618> <@361189553626939394> <@389408270483193858> <@516913729267564544> <@242586194733432832> <@374606174856675329> <@371294029469450241> <@566980244758855714> <@279328745733488641> <@560831907487547392> <@262928706337505281> <@344175830336798721>")
    ...
    if message.content.startswith('@풍자'): #만약 메시지가 !test로 시작한다면
        ...
        embed.set_image(url="https://i.imgur.com/itMEXHt.gif") #embed에 이미지 추가
        await message.channel.send(embed=embed) #embed전송
